...
[data-mobile-nav="fab"] {
  ...
  color: var(--dsw-alias-label-primary, inherit);
  cursor: pointer;
  box-shadow: 0 2px 12px var(--dsw-alias-bg-mask-2);
  -webkit-tap-highlight-color: transparent;
}
...
[data-mobile-nav="backdrop"] {
  ...
  cursor: pointer;
  animation: dsh-mobile-nav-fade .2s ease-in-out;
  -webkit-tap-highlight-color: transparent;
}
...
@media (max-width: 1023px) {
  ...
  [aria-modal="true"]:has(> :first-child > :last-child > button):not(:has([role="navigation"])):not(:has([class*="ZuhsRW"])) {
    ...
    animation: dsh-mobile-nav-sheet-in .22s ease-in-out;
  }
  ...
  :has(> [aria-modal="true"]:has(> :first-child > :last-child > button):not(:has([role="navigation"])):not(:has([class*="ZuhsRW"]))) > :first-child {
    animation: dsh-mobile-nav-fade .18s ease-in-out;
  }
...
exports.COMPAT_CSS = `@media (max-width: 1023px) {
  ...
  [data-aionui-explorer-col] {
    ...
    border-radius: 14px !important;
    overflow: hidden !important;
    box-shadow: 0 -4px 28px var(--dsw-alias-bg-mask-2) !important;
    animation: dsh-mobile-nav-sheet-up .24s ease-in-out !important;
  }
  ...
  [data-aionui-preview-col] {
    ...
    transition:
      ...
      right .24s ease-in-out,
      top .24s ease-in-out,
      bottom .24s ease-in-out,
      width .24s ease-in-out,
      height .24s ease-in-out,
      border-radius .24s ease-in-out,
      box-shadow .24s ease-in-out,
      padding-top .24s ease-in-out !important;
  }
  ...
  [data-mobile-nav="preview-full-toggle"] {
    ...
    transition: background-color .15s, top .24s ease-in-out;
  }
  ...
  [data-mobile-nav="stats"] {
    ...
    scrollbar-width: thin !important;
    scrollbar-color: var(--dsw-alias-border-l1) transparent !important;
...
function installDebugBadge(ctx) {
    ctx.effect(() => {
        ...
        badge.style.cssText = [
            ...
            'background:var(--dsw-alias-bg-mask-photo)', 'color:var(--dsw-static-neutral-00)', 'font:11px/1.5 ui-monospace,monospace',
    ...
    }, 'dsh-wechat-bridge/mobile-ui: debug badge');
}
};
...
function installPhoneChrome(ctx) {
    ...
    }, 'dsh-wechat-bridge/mobile-ui: status bar theme + viewport + zoom guard');
}
};
...
function installAionuiCompat(ctx) {
    ...
    }, 'dsh-wechat-bridge/mobile-ui: aionui explorer close marker');
    ...
    }, 'dsh-wechat-bridge/mobile-ui: preview sheet open marker');
    ...
    }, 'dsh-wechat-bridge/mobile-ui: sheet rise animation replay');
}
};
...
function installStatsLine(ctx) {
    ...
    }, 'dsh-wechat-bridge/mobile-ui: stats line marker');
}
};
 ...
 */
function apply(ctx) {
    ctx.effect(() => ctx.locale.register(locales_ts_1.NS, { zh: locales_ts_1.zh, en: locales_ts_1.en }), 'dsh-wechat-bridge/mobile-ui: dictionaries');
    ctx.effect(() => {
        const tag = document.createElement('style');
        tag.dataset.plugin = 'dsh-wechat-bridge/mobile-ui';
        tag.dataset.pluginCss = 'dsh-wechat-bridge/mobile-ui/mobile.css';
        tag.textContent = index_ts_1.MOBILE_CSS;
        document.head.appendChild(tag);
        return () => {
            tag.remove();
        };
    }, 'dsh-wechat-bridge/mobile-ui: styles');
